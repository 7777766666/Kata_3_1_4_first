...
public class Init {
    ...
    public void createTable() {
        if (roleService.getList().isEmpty()) {
            ...
            User user1 = new User("user", "MainUser", 55, "a",                   //"user@gmail.com",  $2a$12$QEP7TBCJvY2BIA1ez4uSE.TOfSayI40I8.fv/gRZHczVN2H/uqOMq
                    "$2a$12$qMD1dXg4/kXleOBqLfTzsOf8muowYIBAaUp8BnQZITaYzdwKfvRFi", setRole2);

            User admin1 = new User("admin", "MainAdmin", 99, "a",               //"admin@gmail.com",  "$2a$12$cMXTYl25dfJ616oWo5CjhOsZIXYdQSDyIorgNrYN4cCn4PLrVKwjC"
                    "$2a$12$RTR7TtmVoD1ZYS/tttyWJ.ShHH6ivsn9OnInWQoZbCmds3eReD/2y", setRole1);
